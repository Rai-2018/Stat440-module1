...
rf = RandomForestRegressor(n_estimators=800,min_samples_split= 5, min_samples_leaf= 1, max_features= 'sqrt', max_depth= 80, bootstrap= False)
...
# result.to_csv("kaggle_submit_3.txt",sep=",",index=False)
