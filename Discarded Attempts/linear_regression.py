...
def process(full_table):
    ...
    select_country = table[(table.index == 0) | (table.country_new < 3)]
    ...
    table = table.reset_index(drop=True)
    select_province= table[(table.index == 0) | (table.province_new < 3)]
