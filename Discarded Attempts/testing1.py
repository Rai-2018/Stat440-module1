...
full_table_onehot = pd.get_dummies(full_table, columns=[ "city_cat","province_cat", "country_cat",
                                    "V1_cat", "confirmed_cat"], 
                                   prefix=["city_cat","province_cat", "country_cat",
                                    "V1_cat", "confirmed_cat"],drop_first=True)
...
drop = ["age","sex","city","province",
        ...
        "outcome","duration","Id", "sex_new","sex_cat","outcome_cat",
