...
full_table_onehot = pd.get_dummies(full_table, columns=["sex", "city","province", "country",
                                    "V1", "confirmed","outcome", "maj_symptoms"], 
                                   prefix=["sex", "city","province", "country",
                                           "V1", "confirmed","outcome", "maj_symptoms"],drop_first=True)
